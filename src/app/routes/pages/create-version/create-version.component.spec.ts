...
import { MatFormFieldModule, MatIconModule, MatOptionModule,
   MatSelectModule, MatDialogRef, MatDialogModule, MAT_DIALOG_DATA, MatToolbar, MatToolbarModule, MatExpansionPanel } from '../../../../../node_modules/@angular/material';
...
//     component.add();
//     // expect(newVersion.add()).arguments({selectedCurriculumName: 'java', numberOfWeeks: 7, selectedTopics: [{"id": 1,"name": "Core Java" }]});
//   });
// });
